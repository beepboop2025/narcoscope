...
import { readResearchNetwork } from '../../lib/research-network.mjs'
  ...
  return {
    ...
    api: {
      ...
      resources: [
        ...
        'palimpsest-bridge', 'palimpsest-corridors', 'palimpsest-bri', 'connected-research', 'research-network', 'markets', 'market-observations',
      ],
    },
    mcp: {
...
export async function resource(name, params = {}, dependencies = {}) {
  ...
  switch (name) {
    ...
    case 'research-network': return readResearchNetwork(params, dependencies)
